const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "В) На картинг чи грати у футбол/карти з друзями.", type: "D" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Б) Охоронну фірму чи магазин зброї.", type: "D" },
  ...
  },
  {
    ...
    options: [
      { text: "А) Індивідуальні, де важлива кмітливість (шахи, більярд, покер).", type: "C" },
